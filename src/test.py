...
def example1(ta):
    ta.SP([2, 0, 1000, [5, 25, 4], 1])
    ta.SP([2, 4, 700, [1, 35, 4], 1])
    ta.SP([2, 8, 800, [8], 1])
    ta.RE([2, [0, 4, 1, 5, 8, 2, 6, 9, 3, 7]])
    ta.FU([2, [0, 1, 2]])
    ta.AN([2, 0, 3])
    ta.PR([2, 0, "auto_unroll_max_step$512"])
    ta.AN([2, 7, 2])
...
Example 3:
    ...
    [['CHW', 2, 'local'], 
    ['SP', 2, 0, 1000, [1, 40, 5], 1], 
    ['SP', 2, 4, 700, [1, 140, 1], 1], 
    ['SP', 2, 8, 800, [5], 1], 
    ['RE', 2, [0, 4, 1, 5, 8, 2, 6, 9, 3, 7]], 
    ['FSP', 3, 0, 1, 2], 
    ['FSP', 3, 3, 2, 2], 
...
def example3(ta):
    ...
    ta.FU([3, [0, 1, 2, 3]])
    ta.AN([3, 0, 3])
    ta.PR([2, 0, "auto_unroll_max_step$0"])
    ta.AN([2, 9, 2])
...
def example4(ta):
    ...
    ta.FU([3, [0, 1]])
    ta.AN([3, 0, 3])
    ta.PR([2, 0, "auto_unroll_max_step$16"])
    ta.AN([2, 9, 2])
